...
//     public Boolean withdrawal(TransactionDto transDto, String token) throws Exception {
...
//     public Boolean deposit(TransactionDto transDto, String token) throws Exception {
//         Account updatedAccount = accountService.getAccountById(transDto.getFromAcct(), token);
//         if (updatedAccount != null) {
//             double accountBal = updatedAccount.getBalance();
//             double withdrawlAmt = transDto.getTransAmount();
...
//     public Boolean transfer(TransactionDto transDto, String token) throws Exception {
...
//     public Optional<List<Transaction>> getTransactionByAccountNumber(long accountNumber, String token) throws Exception {
